...
public enum AppPropertyType {
    ...
    HAS_WELCOME_DIALOG,
    HAS_TOP_TOOLBAR,
    HAS_FILE_TOOLBAR, HAS_CLIPBOARD_TOOLBAR, HAS_UNDO_TOOLBAR, HAS_NAVIGATION_TOOLBAR, HAS_HELP_TOOLBAR,
    ...
    EDIT_DIALOG_ERROR_TITLE,    EDIT_DIALOG_ERROR_CONTENT,
    ADD_DIALOG_ERROR_TITLE,    ADD_DIALOG_ERROR_CONTENT,
    LOAD_IMAGE_TITLE,         LOAD_IMAGE_CONTENT,
    LOAD_IMAGE_ERROR_TITLE,   LOAD_IMAGE_ERROR_CONTENT,
}