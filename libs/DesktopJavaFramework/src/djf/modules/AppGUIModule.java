...
public class AppGUIModule {
    ...
    // THIS IS FOR THE NAVIGATION BUTTONS IF WE'RE USING THEM
    ...
    public void loadGUI(Stage initPrimaryStage) throws LanguageException {
        ...
        // WITHOUT THE TOP TOOLBAR
            ...
            props.addProperty(HAS_NAVIGATION_TOOLBAR, FALSE);
    ...
    public AppNavigationController getNavigationController() {
    ...
    /**
     * Accessor method for getting the navigation toolbar, within which all 
     *
     * @return This application GUI's navigation toolbar.
     */
