...
public class AppDialogsFacade {
    ...
    public static void showLanguageDialog(AppLanguageModule languageSettings) throws LanguageException {
        ...
        //System.out.println(headerText+contentText);
    ...
    public static void showMessageDialog(Stage parent, Object titleProperty, Object contentTextProperty) {
        //System.out.println(titleProperty.toString()+contentTextProperty.toString());
        PropertiesManager props = PropertiesManager.getPropertiesManager();
        String title = props.getProperty(titleProperty);
        String contentText = props.getProperty(contentTextProperty);
        System.out.println("111"+title+contentText+"000");
    ...
    public static File showLoadImageDialog(Stage window, AppPropertyType openTitleProp) {
        FileChooser fc = new FileChooser();
        fc.setInitialDirectory(new File(PATH_WORK));
        
        FileChooser.ExtensionFilter extFilter = 
            new FileChooser.ExtensionFilter("Image files (*.png *.jpg *.jpeg *.JPEG)", "*.png","*.jpg","*.jpeg","*.JPEG");
        fc.getExtensionFilters().add(extFilter);
        //fc.setSelectedExtensionFilter(new FileChooser.ExtensionFilter("Images", ".jpg", ".jpeg", ".JPEG", ".png"));
        PropertiesManager props = PropertiesManager.getPropertiesManager();
