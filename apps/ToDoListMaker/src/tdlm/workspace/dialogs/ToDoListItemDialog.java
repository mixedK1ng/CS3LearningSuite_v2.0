...
import static tdlm.ToDoPropertyType.TDLM_ITEM_DIALOG_FOOLPROOF_SETTINGS;
...
import tdlm.workspace.foolproof.ToDoItemDialogFoolProofDesign;
...
public class ToDoListItemDialog extends Stage {
    ...
    private void initDialog() {
        ...
        categoryTextField.setPromptText("(necessary)");
        descriptionTextField.setPromptText("(necessary)");
        assignedToTextField.setPromptText("(optional)");
        ...
        assignedToTextField.setOnAction(e->{   //forQ4
            processCompleteWork();
        });
    ...
    private void processCompleteWork() {
        ...
        if (editing) {
            if (data.isValidToDoItemEdit(itemToEdit, category, description, startDate, endDate, assignedTo, completed)) {
        ...
        // IF WE ARE ADDING
            ...
            if (data.isValidNewToDoItem(category, description, startDate, endDate, assignedTo, completed)) 
            {
                ...
                // OPEN MESSAGE DIALOG EXPLAINING WHAT WENT WRONG
                // @todo
                System.out.println("现在是"+category+description+assignedTo+completed);
    ...
    public void showAddDialog() {        
        ...
        //assignedToLabel.setText("Assign To:");
    ...
    private void initFoolproofDesign() {
        ...
        foolproofSettings.registerModeSettings(TDLM_ITEM_DIALOG_FOOLPROOF_SETTINGS, 
            new ToDoItemDialogFoolProofDesign((ToDoListMakerApp)app,(ToDoListItemDialog)this));
