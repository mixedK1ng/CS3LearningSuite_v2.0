...
public class ToDoWorkspace extends AppWorkspaceComponent {
	...
	VBox toDoListPane           = tdlBuilder.buildVBox(TDLM_PANE,               null,           null,   CLASS_TDLM_BOX, HAS_KEY_HANDLER,             FOCUS_TRAVERSABLE,      ENABLED);
        ...
        Button upItemButton     = tdlBuilder.buildIconButton(TDLM_UP_ITEM_BUTTON,   itemButtonsPane,    null,   CLASS_TDLM_BUTTON, HAS_KEY_HANDLER,   FOCUS_TRAVERSABLE,  DISABLED);
        Button downItemButton     = tdlBuilder.buildIconButton(TDLM_DOWN_ITEM_BUTTON,   itemButtonsPane,    null,   CLASS_TDLM_BUTTON, HAS_KEY_HANDLER,   FOCUS_TRAVERSABLE,  DISABLED);
        ...
        TableColumn assigntoColumn   = tdlBuilder.buildTableColumn(  TDLM_ASSIGNED_TO_COLUMN, itemsTable,         CLASS_TDLM_COLUMN);
        ...
        assigntoColumn.setCellValueFactory(  new PropertyValueFactory<String,    String>("assignedTo"));
...
//        });
        ...
        ownerTextField.setOnKeyPressed((KeyEvent event) -> {
            app.getFileModule().markAsEdited(true);
        });
        nameTextField.setOnKeyPressed((KeyEvent event) -> {
            app.getFileModule().markAsEdited(true);
        });


        
//        itemsTable.editableProperty().addListener(e->{
//            app.getFileModule().markAsEdited(true);
//        });
        ...
        ItemsTableController itemsTableController = new ItemsTableController(app);
        ...
        upItemButton.setOnAction(e->{
            itemsTableController.processMoveUpColumn();
            
            
        });
        
        downItemButton.setOnAction(e->{
            itemsTableController.processMoveDownColumn();
