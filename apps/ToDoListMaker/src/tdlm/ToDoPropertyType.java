...
public enum ToDoPropertyType {
    ...
    TDLM_ITEM_DIALOG_FOOLPROOF_SETTINGS,
    ...
    TDLM_ITEM_DIALOG_END_DATE_PROMPT,//forQ3
    TDLM_ITEM_DIALOG_END_DATE_PICKER,
    TDLM_ITEM_DIALOG_ASSIGNED_TO_PROMPT,//forQ4
