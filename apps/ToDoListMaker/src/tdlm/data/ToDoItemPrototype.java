...
public class ToDoItemPrototype implements Cloneable {
    ...
    public static final String DEFAULT_ASSIGNTO = "?";
    ...
    public ToDoItemPrototype() {
        ...
        assignedTo = new SimpleStringProperty(DEFAULT_ASSIGNTO);
        completed = new SimpleBooleanProperty(DEFAULT_COMPLETED);
    }

    public ToDoItemPrototype(String initCategory, String initDescription, LocalDate initStartDate, LocalDate initEndDate, String initAssignTo, boolean initCompleted) {
        this();
        category.set(initCategory);
        description.set(initDescription);
        startDate.set(initStartDate);
        endDate.set(initEndDate);
        assignedTo.set(initAssignTo);
    ...
    public void reset() {
        ...
        setAssignedTo(DEFAULT_ASSIGNTO);
