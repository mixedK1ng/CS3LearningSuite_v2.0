...
public class ToDoData implements AppDataComponent {
    ...
    public boolean isValidToDoItemEdit(ToDoItemPrototype itemToEdit, String category, String description, LocalDate startDate, LocalDate endDate, String assignTo, boolean completed) {
        return isValidNewToDoItem(category, description, startDate, endDate, assignTo, completed);
    }

    public boolean isValidNewToDoItem(String category, String description, LocalDate startDate, LocalDate endDate, String assignTo, boolean completed) {
